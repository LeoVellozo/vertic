...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'site_backup_2a4ef71b227881da4287_20220610224312_archive.zip';
	const ARCHIVE_SIZE		 = '45778358';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '2a4ef71-10224312';
    const SECONDARY_PACKAGE_HASH = '845c9ae-10224312';
	const VERSION			 = '1.4.6';
